...
var pinkCG, yellowCG,redCG,blueCG; 
...
{
        player4 =createSprite(1300,Math.round(random(50, 250)));
        player4.scale =0.06;
        player4.velocityX = -(6 + 2*distance/150);
        player4.addAnimation("opponentPlayer3",oppRed1Img);
